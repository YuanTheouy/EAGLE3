...
if __name__ == "__main__":
    ...
    if args.answer_file:
        ...
        # Default to a 'results' directory in the project root to avoid cluttering
        # script_dir is eagle/evaluation/
        # parent_dir is eagle/
        # project_root is parent of eagle/
        project_root = os.path.dirname(parent_dir)
        answer_file = f"{project_root}/results/{args.bench_name}/{args.model_id}.jsonl"
