...
parser.add_argument('--trainpath', type=str,
                    default="/workspace/datasets/ultra200k/qwen_output/ultra200_gen_train_regenerated_final.jsonl")
parser.add_argument('--testpath', type=str,
                    default="/workspace/datasets/ultra200k/qwen_output/regenerated_gen_test_qwenvl_T00_final.jsonl")
